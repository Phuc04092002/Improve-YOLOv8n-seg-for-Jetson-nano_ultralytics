        ...
        with open(label_file, "w") as f:
            for ann in anns:
                ...
                if seg_points is None:
                    x, y, w, h = ann["bbox"]
                    seg_points = np.array([[x, y], [x + w, y], [x + w, y + h], [x, y + h]])
...
convert_coco_to_yolo_seg(
    "D:/coco/annotations/instances_train2017.json", "D:/coco/labels/train2017", "D:/coco/images/train2017"
)

# Chuyển val2017
convert_coco_to_yolo_seg(
    "D:/coco/annotations/instances_val2017.json", "D:/coco/labels/val2017", "D:/coco/images/val2017"
)
